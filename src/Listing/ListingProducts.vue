            ...
            <div class="modal-content">
              ...
              <div class="styleModal">
               ...
               <h1> Saisie prix</h1>
                <input
                  type="number"
                  v-model="price_provider"
                  placeholder="Saisie le prix provider"
                />
              </div>
              <div class="modal-footer">
                ...
                <button
                  type="button"
                  @click="updatePriceProvider(selectedUser.id)"
...
export default {
  ...
  methods: {
    ...
    updatePriceProvider(id) {
   
   const json = JSON.stringify({ "price_provider": this.price_provider });

      axios
        .put("http://37.187.244.116:5000/product/" + id,json, {
          headers: {
       'Content-Type': 'application/json'
          },
        })
